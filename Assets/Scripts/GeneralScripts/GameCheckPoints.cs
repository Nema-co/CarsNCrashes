...
public class GameCheckPoints : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other) {
        if (other.CompareTag("PlayerCollider")) { // Ensure the player has the "Player" tag
            ...
            if(carProgress != null) {
                ...
                if (CheckPointNumber != 0 && CheckPointNumber == NextCheckPoint) { 
                    ...
                    if (FinalCheckPoint == 1) {
                        ...
                        Debug.LogError("Player current checkpoint: " + CheckPoint + " next checkpoint is: " + NextCheckPoint);
                    }
                }
            }
        }
